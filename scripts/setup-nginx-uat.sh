...
# Script to configure nginx for UAT
...
server {
    listen 80;
    server_name uat.anshumanbiswas.com;
...
server {
    ...
    ssl_certificate /etc/nginx/ssl/uat.anshumanbiswas.com.crt;
    ssl_certificate_key /etc/nginx/ssl/uat.anshumanbiswas.com.key;
